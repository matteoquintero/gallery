<template>
    <Popover class="relative bg-white">
      <div class="mx-auto max-w-9xl px-4 sm:w-3/4">
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              <span class="sr-only">Workflow</span>
              <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=pink&shade=600" alt="" />
            </a>
          </div>
          ...
          <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
            <Popover class="relative" v-slot="{ open }">
              <PopoverButton :class="[open ? 'text-gray-900' : 'text-gray-500', 'group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2']">
                <span>All</span>
                  ...
                  <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                      <a v-for="item in solutions" :key="item.name" :href="item.href" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                        <component :is="item.icon" class="h-6 w-6 flex-shrink-0 text-pink-600" aria-hidden="true" />
                        <div class="ml-4">
            ...
            <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Branding</a>
            <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Web</a>
          ...
          <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            <a href="#" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Search</a>
          </div>
        </div>
      </div>
          ...
          <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div class="px-5 pt-5 pb-6">
              <div class="flex items-center justify-between">
                <div>
                  <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=pink&shade=600" alt="Workflow" />
                </div>
                <div class="-mr-2">
                  <PopoverButton class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pink-500">
            ...
            <div class="space-y-6 py-6 px-5">
              ...
              <div>
                <a href="#" class="flex w-full items-center justify-center rounded-md border border-transparent bg-pink-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-pink-700">Sign up</a>
                <p class="mt-6 text-center text-base font-medium text-gray-500">
                  Existing customer?
                  {{ ' ' }}
                  <a href="#" class="text-pink-600 hover:text-pink-500">Sign in</a>
                </p>
              </div>
            </div>
          </div>
  ...
  const solutions = [
    ...
    { name: 'Security', description: "Your customers' data will be safe and secure.", href: '#', icon: CommunityIcon },
    {
      name: 'Integrations',
  ...
  const callsToAction = [
    { name: 'Watch Demo', href: '#', icon: WelcomeItem },
    { name: 'Contact Sales', href: '#', icon: WelcomeItem },
  ]
  const resources = [
    {
      name: 'Help Center',
    ...
    { name: 'Security', description: 'Understand how we take your privacy seriously.', href: '#', icon: ToolingIcon },
  ]
  const recentPosts = [
